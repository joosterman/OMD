		...
		<div data-role="collapsible-set" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" data-inset="false"
				...
				<div id="detailInformation">
					...
					<p>
						<span id="locationOpenSaLabel"><i>Zaterdag <span id="locationOpenSa"></span></i><br /></span> <span
							id="locationOpenSuLabel"><i>Zondag <span id="locationOpenSu"></span>
						</i></span>
					</p>
			...
			<div data-role="collapsible" id="locImageBlock">
				...
				<div class="notLoggedIn">
					U moet ingelogd zijn om afbeeldingen te kunnen uploaden. Klik <a class="loginLink" data-rel="dialog"
						data-transition="slidedown" data-mini="true" href="#login">hier</a> om in te loggen.
				</div>
			...
			<div data-role="collapsible" id="locCommentBlock">
				...
				<div class="comment">
					...
					<div class="notLoggedIn">
						U moet ingelogd zijn om een reactie te kunnen plaatsen. Klik <a class="loginLink" data-rel="dialog"
							data-transition="slidedown" data-mini="true" href="#login">hier</a> om in te loggen.
					</div>
