<div data-role="page" id="voorwoord">
	...
	<div data-role="content">
		...
		<p>Dit jaar krijgen tien historische groene monumenten of waardevolle gebieden in Delft extra aandacht. In twee gebieden, &eacute;&eacute;n ten noorden van de oude binnenstad en &eacute;&eacute;n ten zuiden ervan, zijn routes uitgezet om er het groen en de historische betekenis ervan te ontdekken. Daarnaast zijn er natuurlijk ook weer veel gebouwde monumenten opengesteld. Ze staan allemaal in dit programmaboekje. U zult ze vast nog niet allemaal van binnen hebben gezien. Ik nodig u uit te gaan wandelen en ze te bezoeken. </p>
		<div class="authorbox">Mil&egrave;ne Junius,<br />
Wethouder Monumentenzorg</div>
	</div>
</div>